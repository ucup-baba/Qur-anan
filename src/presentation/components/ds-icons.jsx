// Shared icon primitives (simple, monoline — no AI-slop illustrations)

const Icon = ({ d, size = 18, stroke = 1.6, style }) => (
...
// Small SVG placeholder (striped) — used where imagery would go
const Placeholder = ({ label = 'imagery', aspect = '16/9', style }) => (
  <div style={{
    aspectRatio: aspect,
...
Object.assign(window, { Icon, Icons, Placeholder });
